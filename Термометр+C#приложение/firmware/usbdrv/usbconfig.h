...
#define  USB_CFG_VENDOR_ID       0xd2, 0xff
 ...
 */
#define  USB_CFG_DEVICE_ID       0xaa, 0x01
 ...
 */
#define USB_CFG_DEVICE_VERSION  0x14, 0x15
/* Номер версии устройства: сначала младший номер, затем старший номер.
 */
#define USB_CFG_VENDOR_NAME     'B', 'r', '.', 'M', 'i', 's', 'h', 'a'
 ...
 */
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', 'T', 'h', 'e', 'r', 'm', 'o', 'm', 'e', 't', 'e', 'r'
